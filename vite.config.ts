...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'GeoNexus - Real-Time Global Intelligence Dashboard',
    description: 'AI-powered real-time global intelligence dashboard with live news, markets, military tracking, infrastructure monitoring, and geopolitical data. OSINT in one view.',
    keywords: 'GeoNexus, global intelligence, geopolitical dashboard, world news, market data, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, oil prices, government spending, polymarket predictions',
  ...
  tech: {
    title: 'GeoNexus Tech - Real-Time AI & Tech Industry Dashboard',
    description: 'AI-powered real-time tech industry dashboard tracking tech giants, AI labs, startup ecosystems, funding rounds, and tech events worldwide.',
    keywords: 'GeoNexus, tech dashboard, AI industry, startup ecosystem, tech companies, AI labs, venture capital, tech events, tech conferences, cloud infrastructure, datacenters, tech layoffs, funding rounds, unicorns, FAANG, tech HQ, accelerators, Y Combinator, tech news',
    url: 'https://tech.geonexus.live/',
    siteName: 'GeoNexus Tech',
    shortName: 'GeoNexusTech',
  ...
  finance: {
    title: 'GeoNexus Finance - Real-Time Markets & Trading Dashboard',
    description: 'AI-powered real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    keywords: 'GeoNexus, finance dashboard, trading dashboard, stock market, forex, commodities, central banks, crypto, economic indicators, market news, financial centers, stock exchanges, bonds, derivatives, fintech, hedge funds, IPO tracker, market analysis',
    url: 'https://finance.geonexus.live/',
    siteName: 'GeoNexus Finance',
    shortName: 'GeoNexusFinance',
  ...
  return {
    ...
    transformIndexHtml(html) {
      return html
        ...
        .replace(/"name": "GeoNexus"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "GeoNexus"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/geonexus\.live\/"/, `"url": "${activeMeta.url}"`)
        .replace(/"description": "AI-powered real-time global intelligence dashboard with live news, markets, military tracking, infrastructure monitoring, and geopolitical data."/, `"description": "${activeMeta.description}"`)
