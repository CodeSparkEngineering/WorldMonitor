...
export const translations = {
    en: {
        auth: {
            loginTitle: "SYSTEM_ACCESS",
            loginSubtitle: "Authenticate to access global intelligence dashboard",
            registerTitle: "NEW_AUTHORIZATION",
            registerSubtitle: "Request clearance for global node access",
            resetTitle: "RECOVER_ACCESS",
            resetSubtitle: "Initiate password reset protocol",
            emailLabel: "Email Address",
            emailLabelReset: "Registered Email",
            emailPlaceholder: "Email Address",
            passwordLabel: "Password",
            btnLogin: "INITIATE_LINK",
            btnRegister: "REQUEST_CLEARANCE",
            btnReset: "SEND_RECOVERY_LINK",
            btnSending: "SENDING...",
            btnRegistering: "REGISTERING...",
            authenticating: "AUTHENTICATING...",
            continueGoogle: "CONTINUE_WITH_GOOGLE",
            or: "OR",
            forgotPassword: "Forgot Password?",
            backToLogin: "Back to Login",
            noIdentity: "Don't have clearance? Request Access",
            alreadyHaveIdentity: "Already have clearance? Initiate Link",
            restricted: "RESTRICTED ACCESS // AUTHORIZED PERSONNEL ONLY",
            toasts: {
                adminAccess: "Admin bypass active. Redirecting...",
                accessGranted: "Clearance verified. System link active.",
                identityCreatedCheckout: "Identity created. Redirecting to payment...",
                noSubCheckout: "No active subscription. Redirecting to payment...",
                ...
                googleCreated: "Identity created via Google. Linking...",
                googleConfirmed: "Google identity verified. Linking...",
                googleFailed: "Google authentication failed",
                enterEmailFirst: "Please enter your email first",
                resetLinkSent: "Recovery protocol initiated. Check email.",
                noOperativeEmail: "No operative found with this email",
                resetFailed: "Recovery protocol failed"
            }
        },
        navbar: {
    ...
    pt: {
        auth: {
            loginTitle: "ACESSO_SISTEMA",
            loginSubtitle: "Autentique-se para acessar o painel de inteligência global",
            registerTitle: "NOVA_AUTORIZAÇÃO",
            registerSubtitle: "Solicite credencial para acesso ao nó global",
            resetTitle: "RECUPERAR_ACESSO",
            resetSubtitle: "Iniciar protocolo de redefinição de senha",
            emailLabel: "Endereço de E-mail",
            emailLabelReset: "E-mail Registrado",
            emailPlaceholder: "Endereço de E-mail",
            passwordLabel: "Senha",
            btnLogin: "INICIAR_CONEXÃO",
            btnRegister: "SOLICITAR_CREDENCIAL",
            btnReset: "ENVIAR_LINK_RECUPERAÇÃO",
            btnSending: "ENVIANDO...",
            btnRegistering: "REGISTRANDO...",
            authenticating: "AUTENTICANDO...",
            continueGoogle: "CONTINUAR_COM_GOOGLE",
            or: "OU",
            forgotPassword: "Esqueceu a Senha?",
            backToLogin: "Voltar ao Login",
            noIdentity: "Não possui credencial? Solicitar Acesso",
            alreadyHaveIdentity: "Já possui credencial? Iniciar Conexão",
            restricted: "ACESSO RESTRITO // APENAS PESSOAL AUTORIZADO",
            toasts: {
                adminAccess: "Acesso administrativo ativo. Redirecionando...",
                accessGranted: "Credencial verificada. Conexão ativa.",
                identityCreatedCheckout: "Identidade criada. Redirecionando para pagamento...",
                noSubCheckout: "Sem assinatura ativa. Redirecionando para pagamento...",
                authFailed: "Falha na autenticação",
                invalidCreds: "Credenciais inválidas",
                userNotFound: "Usuário não encontrado",
                emailInUse: "E-mail já registrado",
                ...
                googleCreated: "Identidade criada via Google. Vinculando...",
                googleConfirmed: "Identidade Google verificada. Vinculando...",
                googleFailed: "Falha na autenticação Google",
                enterEmailFirst: "Por favor, insira seu e-mail primeiro",
                resetLinkSent: "Protocolo de recuperação iniciado. Verifique o e-mail.",
                noOperativeEmail: "Nenhum agente encontrado com este e-mail",
                resetFailed: "Falha no protocolo de recuperação"
            }
        },
        navbar: {
    ...
    es: {
        auth: {
            loginTitle: "ACCESO_SISTEMA",
            loginSubtitle: "Autentíquese para acceder al panel de inteligencia global",
            registerTitle: "NUEVA_AUTORIZACIÓN",
            registerSubtitle: "Solicitar credencial para acceso al nodo global",
            resetTitle: "RECUPERAR_ACCESO",
            resetSubtitle: "Iniciar protocolo de restablecimiento de contraseña",
            emailLabel: "Correo Electrónico",
            emailLabelReset: "Correo Registrado",
            emailPlaceholder: "Correo Electrónico",
            passwordLabel: "Contraseña",
            btnLogin: "INICIAR_CONEXIÓN",
            btnRegister: "SOLICITAR_CREDENCIAL",
            btnReset: "ENVIAR_ENLACE_RECUPERACIÓN",
            btnSending: "ENVIANDO...",
            btnRegistering: "REGISTRANDO...",
            authenticating: "AUTENTICANDO...",
            continueGoogle: "CONTINUAR_CON_GOOGLE",
            or: "O",
            forgotPassword: "¿Olvidó su contraseña?",
            backToLogin: "Volver al Inicio",
            noIdentity: "¿No tiene credencial? Solicitar Acceso",
            alreadyHaveIdentity: "¿Ya tiene credencial? Iniciar Conexión",
            restricted: "ACCESO RESTRINGIDO // SOLO PERSONAL AUTORIZADO",
            toasts: {
                adminAccess: "Acceso de administrador activo. Redirigiendo...",
                accessGranted: "Credencial verificada. Conexión activa.",
                identityCreatedCheckout: "Identidad creada. Redirigiendo al pago...",
                noSubCheckout: "Sin suscripción activa. Redirigiendo al pago...",
                ...
                tooManyRequests: "Demasiadas solicitudes. Inténtelo más tarde.",
                invalidEmail: "Formato de correo inválido",
                googleCreated: "Identidad creada vía Google. Vinculando...",
                googleConfirmed: "Identidad de Google verificada. Vinculando...",
                googleFailed: "Fallo en la autenticación de Google",
                enterEmailFirst: "Por favor, ingrese su correo primero",
                resetLinkSent: "Protocolo de recuperación iniciado. Revise su correo.",
                noOperativeEmail: "No se encontró ningún agente con este correo",
                resetFailed: "Fallo en el protocolo de recuperación"
            }
        },
        navbar: {
            intel_feed: "FEED_INTEL",
