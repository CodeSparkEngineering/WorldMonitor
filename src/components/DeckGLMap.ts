...
export class DeckGLMap {
  ...
  private createLegend(): void {
    ...
    const legendItems = SITE_VARIANT === 'tech'
      ? [
        { shape: shapes.circle(SITE_VARIANT === 'tech' && isLight ? 'rgb(22, 163, 74)' : 'rgb(0, 255, 150)'), label: t('components.deckgl.legend.startupHub') },
        { shape: shapes.circle('rgb(100, 200, 255)'), label: t('components.deckgl.legend.techHQ') },
        { shape: shapes.circle(SITE_VARIANT === 'tech' && isLight ? 'rgb(180, 120, 0)' : 'rgb(255, 200, 0)'), label: t('components.deckgl.legend.accelerator') },
