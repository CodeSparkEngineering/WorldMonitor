...
// VITE_VARIANT=tech → tech.geonexus.live (tech-focused)
// VITE_VARIANT=full → geonexus.live (geopolitical)
// VITE_VARIANT=finance → finance.geonexus.live (markets/trading)
