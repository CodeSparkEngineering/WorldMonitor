// Tech/AI variant - tech.geonexus.app
...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: 'CISA Advisories', url: 'https://rss.geonexus.app/api/rss-proxy?url=' + encodeURIComponent('https://www.cisa.gov/cybersecurity-advisories/all.xml') },
