    ...
    this.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">GEONEXUS</span><span class="version">v${__APP_VERSION__}</span>
          ...
          <a href="https://github.com/CodeSparkEngineering" target="_blank" rel="noopener" class="github-link" title="View on GitHub">
